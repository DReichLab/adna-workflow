...
from prepare_report import recommendation_spike3k
...
class TestPrepareReport(unittest.TestCase):
	...
	def test_pass_rescue(self):
		...
		self.assertEqual(PASS, recommendation_spike3k(test_sample))
